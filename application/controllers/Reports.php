...
class Reports extends CI_Controller {
    ...
    public function production_report()
	{
       ...
       $sql = "
        ...
        (sum(b.leftout_box) * round(b.produced_qty / b.pouring_box)) as leftout_qty,
       ...
       select 
        ...
        0 as closed_mould_qty,
        sum(b.pouring_box) as poured_box,       
        sum(b.pouring_box * d.no_of_cavity)  as poured_qty1,
        sum(b.produced_qty) as poured_qty,
        sum(b.leftout_box) as leftout_box,
       ...
       if(!empty($srch_from_date) && !empty($srch_to_date)   ){
        ...
        $sql = "
               (
                    ...
                    sum(a.planned_box) as planned_box,
                    sum((a.planned_box * b.no_of_cavity)) as planned_qty,
                    sum((a.planned_box * a.no_of_cavity)) as planned_qty1,
                    0 as produced_qty,
                    0 as rejection_qty,
                    0 as despatch_qty
                    from work_planning_info as a
    ...
    public function customer_wise_production_report()
	{
       ...
       /* $sql = "            
        ...
        $sql = "            
                ...
                DATE_FORMAT(SEC_TO_TIME(TIME_TO_SEC(TIMEDIFF(a.breakdown_to_time, a.breakdown_from_time))), '%H:%i') AS breakdown,
                TIME_TO_SEC(TIMEDIFF(a.breakdown_to_time, a.breakdown_from_time)) AS breakdown_sec,
                a.breakdown_remarks
                from moulding_log_item_info as a 
                left join work_planning_info as b on b.work_planning_id = a.work_planning_id
       ...
       if(!empty($srch_from_date) && !empty($srch_to_date)  ){
        ...
        $sql = "
                select 
                    ...
                    if(a.ni = '',0, a.ni) as ni, 
                    if(a.mo = '',0, a.mo) as mo, 
    ...
    public function headcode_wise_rejection_report()
	{
       ...
       if(isset($_POST['srch_key'])) {
        ...
        $sql =" 
            ...
            if(!empty($srch_key) ){
              $sql.=" and concat(b.heat_code,b.days_heat_no) like '%". $srch_key ."%'";
            }
