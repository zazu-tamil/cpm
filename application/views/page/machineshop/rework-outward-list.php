<?php  include_once(VIEWPATH . '/inc/header.php'); ?>
 <section class="content-header">
  <h1> Rework Outward List </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-cubes"></i> Machine Shop</a></li> 
    <li class="active">Rework Outward List</li>
  </ol>
</section>
<!-- Main content -->
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="scrollmodalLabel">Add Rework Outward Entry</h4>
                        <input type="hidden" name="mode" value="Add" />
                        <input type="hidden" name="rework_type" id="rework_type" value="Outward" />
                    </div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content"> 
                            <div class="modal-header">
                                ...
                                <h3 class="modal-title" id="scrollmodalLabel"><strong>Rework Outward Details</strong></h3>
                            </div>
                            <div class="modal-body table-responsive">
                            
                                <span class="master"></span>
                                <b>Rework Outward Items</b><br /> 
