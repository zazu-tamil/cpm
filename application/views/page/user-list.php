          ...
          <tbody>
               <?php
                ...
                <tr> 
                    ...
                    <td><?php echo $user_level_opt[$ls['level']];?></td>    
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h3 class="modal-title" id="scrollmodalLabel">Add User</h3>
                    ...
                    <div class="modal-body">
                         ...
                         <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="user_name" id="user_name" value="" placeholder="Login Name">                                             
                         </div> 
                         <div class="form-group">
                         ...
                         <div class="form-group">
                            <label>User Right</label>
                              <?php echo form_dropdown('level', array('' => 'Select User Rights') + $user_level_opt ,set_value('level') ,' id="level" class="form-control"');?>                                             
                         </div> 
                         <div class="form-group">
                            <label>Status</label>
                            <div class="radio">
        ...
        <div class="modal fade" id="edit_modal" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="scrollmodalLabel">Edit User Login</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
