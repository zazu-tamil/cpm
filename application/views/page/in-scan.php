                      ...
                      <div class="input-group input-group-sm">
                        <input class="form-control" type="text" name="awbno" id="awbno" value="" placeholder="AWB No">  
                            <span class="input-group-btn">
                              <button type="submit" class="btn btn-success btn-flat" name="btn_inscan" value="Single"><i class="fa fa-save"></i>  Save</button>
                            </span>
                      </div>                                   
                 </div>  
             </div> 
        ...
        <div class="box-body">
            <div class="row">   
                 ...
                 <div class="form-group col-md-6">
                    <label>AWB No </label>  
                    <textarea class="form-control" name="awbno" id="awbno" rows="5" placeholder="AWB No"> </textarea>  
                    <br /><i class="text-maroon"> Note : Seperate by Comma</i>  
                 </div>  
