<?php  include_once(VIEWPATH . '/inc/header.php'); ?>
 <section class="content-header">
  <h1>Openning Floor Stock</h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-cubes"></i> Master</a></li> 
    <li class="active">Openning Floor Stock</li>
  </ol>
</section>
<!-- Main content -->
               ...
               <?php
                ...
                <tr> 
                    ...
                    <td class="text-center hide">
                        <button data-toggle="modal" data-target="#edit_modal" value="<?php echo $ls['floor_stock_id']?>" class="edit_record btn btn-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></button>
                    </td>                                  
                    <td class="text-center">
                        <button value="<?php echo $ls['floor_stock_id']?>" class="del_record_cfs btn btn-danger btn-xs" title="Delete"><i class="fa fa-remove"></i></button>
                    </td>                                      
                </tr>
                <?php
                    }
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header"> 
                        ...
                        <h3 class="modal-title" id="scrollmodalLabel">Edit Core Floor Stock</h3>
