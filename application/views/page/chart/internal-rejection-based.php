...
<section class="content"> 
        ...
        <div class="box box-info noprint"> 
            ...
            <div class="box box-success">
              <div class="box-header with-border noprint"><h3 class="box-title"><?php echo $srch_rej_grp ; ?>  Dept Rejection Type Wise Rejection Based On <?php echo ($type == 1 ? 'Qty' : 'Weight') ; ?></h3>
              ...
              <div class="box-body">
                ...
                <tr>
                    <td colspan="3" class="">
                        ...
                        <?php if(($submit_flg) and fmod($type, 2) == 1) { ?>
                         <?php foreach($rej_type_group as $grp => $info) { ?>
                             <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="box box-info">
                                        <div class="box-header with-border">
                                          <i class="fa fa-bar-chart-o"></i> 
                                          <h4 class="box-title">DataSheet</h4> 
                                        </div>
                                        <div class="box-body">
                             ...
                             <?php } ?>
                             <?php } ?>
                             <?php if(($submit_flg) and fmod($type, 2) == 0) { ?>
                             <?php foreach($rej_type_group as $grp => $info) { ?>
                                 <div class="row">
                                    <div class="col-md-6">
                                        <div class="box box-info">
