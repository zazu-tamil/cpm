<?php  include_once(VIEWPATH . '/inc/header.php'); ?>
 <section class="content-header">
  <h1>Core Maker Rate List</h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-cubes"></i> Master</a></li> 
    <li class="active">Core Maker Rate List</li>
  </ol>
</section>
<!-- Main content -->
<section class="content"> 
  ...
  <div class="box box-info">
       ...
       <div class="box-body"> 
            <form action="<?php echo site_url('core-maker-rate-list');?>" method="post" id="frm">
            <div class="row">  
                ...
                <div class="col-sm-3 col-md-4">
                    ...
                    <input type="text" class="form-control" name="srch_key1" id="srch_key1" value="<?php echo set_value('srch_key1','') ?>" placeholder="Search Pattern Name,Core Item" />
                </div>
               ...
               <?php
                ...
                <tr> 
                    ...
                    <td class="text-center">
                        <button data-toggle="modal" data-target="#edit_modal" value="<?php echo $ls['core_maker_rate_id']?>" class="edit_record btn btn-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></button>
                    </td>                                  
                    <td class="text-center">
                        <button value="<?php echo $ls['core_maker_rate_id']?>" class="del_record btn btn-danger btn-xs" title="Delete"><i class="fa fa-remove"></i></button>
                    </td>                                      
                </tr>
                <?php
                    }
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header"> 
                        ...
                        <h3 class="modal-title" id="scrollmodalLabel"><strong>Add Core Maker Rate Info</strong></h3>
                    ...
                    <div class="modal-body">
                         <div class="row"> 
                             ...
                             <div class="form-group col-md-4">
                                <label>Core Item</label>
                                <?php echo form_dropdown('core_item_id',array('' => 'Select') ,set_value('core_item_id') ,' id="core_item_id" class="form-control"');?>                                              
                             </div>
                         </div> 
                         <div class="row">  
                             ...
                             <div class="form-group col-md-3">
                                ...
                                <input class="form-control" type="number" name="rate" id="rate" step="any" value="" placeholder="Rate">                                             
                             </div>
                             <div class="form-group col-md-3">
                                <label>Status</label>
                                <div class="radio">
        ...
        <div class="modal fade" id="edit_modal" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="scrollmodalLabel"><strong>Edit Core Maker Rate Info</strong> </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        <input type="hidden" name="mode" value="Edit" />
                        <input type="hidden" name="core_maker_rate_id" id="core_maker_rate_id" />
                    </div>
                    <div class="modal-body"> 
                         <div class="row"> 
                             <div class="form-group col-md-4">
