             ...
             <div class="row">   
                 <div class="form-group col-md-3"> 
                    ...
                    <div class="input-group date">
                      ...
                      <input type="text" class="form-control pull-right datepicker" id="from_date" name="from_date" value="<?php echo set_value('from_date');?>">
                    </div>
                    <!-- /.input group -->                                             
                 </div> 
                 <div class="form-group col-md-3"> 
                    ...
                    <div class="input-group date">
                      ...
                      <input type="text" class="form-control pull-right datepicker" id="to_date" name="to_date" value="<?php echo set_value('to_date');?>">
                    </div>
                    <!-- /.input group -->                                             
                 </div>
