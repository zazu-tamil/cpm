<?php  include_once(VIEWPATH . '/inc/header.php'); ?>
 <section class="content-header">
  <h1>Core Openning Stock</h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-cubes"></i> Core Shop</a></li> 
    <li class="active">Core Openning Stock</li>
  </ol>
</section>
<!-- Main content -->
               ...
               <?php
                ...
                <tr> 
                    ...
                    <td class="text-center">
                        <button data-toggle="modal" data-target="#edit_modal" value="<?php echo $ls['core_floor_stock_id']?>" class="edit_record btn btn-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></button>
                    </td>                                  
                    <td class="text-center">
                        <button value="<?php echo $ls['core_floor_stock_id']?>" class="del_record_cfs btn btn-danger btn-xs" title="Delete"><i class="fa fa-remove"></i></button>
                    </td>                                      
                </tr>
                <?php
                    }
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header"> 
                        ...
                        <h3 class="modal-title" id="scrollmodalLabel">Add Core Floor Stock</h3>
                    ...
                    <div class="modal-body">
                       <div class="row">
                         ...
                         <div class="row"> 
                             <div class="form-group col-md-5">
                                <label for="pattern_item">Core Item Name</label>
                                <?php echo form_dropdown('core_item_id',array('' => 'Select Core Item') ,set_value('core_item_id') ,' id="core_item_id" class="form-control"');?>                                             
                             </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header"> 
                        ...
                        <h3 class="modal-title" id="scrollmodalLabel">Edit Core Opening Stock</h3>
                        <input type="hidden" name="mode" value="Edit" />
                        <input type="hidden" name="core_floor_stock_id" id="core_floor_stock_id" />
                    </div>
                    <div class="modal-body"> 
                       <div class="row">
                             <div class="form-group col-md-6">
                                ...
                                <div class="input-group date">
                                  <div class="input-group-addon">
                                    ...
                                    <input type="text" class="form-control pull-right datepicker" id="floor_stock_date" name="floor_stock_date" value="">
                                 </div>                                                
                             </div> 
                             <div class="form-group col-md-6">
                                <label for="customer_id">Customer</label>
