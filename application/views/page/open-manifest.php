        ...
        <div class="box-body">
             ...
             <div class="row">   
                 ...
                 <div class="form-group col-md-3">
                    <label>From</label>
                     <div class="input-group">
                         <?php echo form_dropdown('from_city_code', array('' => 'Select') + $state_opt ,set_value('from_city_code','') ,' id="from_city_code" class="form-control"');?>
                      </div>
                      <!-- /.input group -->                                           
                 </div> 
                 <div class="form-group col-md-3">
                    <label>To</label>
                      <div class="input-group">
                        <?php echo form_dropdown('to_city_code',array('' => 'Select') + $state_opt ,set_value('to_city_code','') ,' id="to_city_code" class="form-control"');?> 
                ...
                <div class="form-group col-md-2 text-left">
                    <br />
                    <button class="btn btn-success" name="btn_show" value="Show AWB'"><i class="fa fa-search"></i> Show AWB No</button>
                </div>
             </div>  
         ...
         <div class="box box-success"> 
            ...
            <div class="box-body">
                ...
                <div class="form-group col-md-2"> 
                    ...
                    <label class="text-info"><?php  echo $this->input->post('manifest_type') ;   ?></label>   
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button class="btn btn-danger btn-sm btn-del" type="button" name="remove_awb" value="<?php echo $info['awbno']?>" /><i class="fa fa-remove"></i></button>
