               ...
               <?php
                ...
                <tr> 
                    ...
                    <td class="text-center"> <span class="text-hide"><?php echo $info['flg_state']?></span>
                        <?php if($info['flg_state'] == 1) { ?><i class="fa fa-check text-success"></i><?php } else {?><i class="fa fa-remove text-danger"></i><?php } ?></td>
                    <td class="text-center">  <span class="text-hide"><?php echo $info['flg_city']?></span>
                        <?php if($info['flg_city'] == 1) { ?><i class="fa fa-check text-success"></i><?php } else {?><i class="fa fa-remove text-danger"></i><?php } ?></td>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h3 class="modal-title" id="scrollmodalLabel">Edit : AIR - Domestic Rate</h3>
                    ...
                    <div class="modal-body"> 
                        <div class="row"> 
                             <div class="form-group col-md-4">
                                <label>Source & Destination Within the Same State </label>                                             
                             </div> 
                             ...
                             <div class="form-group col-md-4">
                                <label>Source & Destination Within the Same City </label>                                             
                             </div> 
                             <div class="form-group col-md-2">
                               <label>
                         ...
                         <div class="row"> 
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" id="min_weight" name="min_weight" class="form-control col-2" style="text-align: right;">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group"> 
                                    <input class="form-control" type="text" name="min_charges" id="min_charges" style="text-align: right;">
                         ...
                         <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" id="addt_weight" name="addt_weight" class="form-control" style="text-align: right;">
                                    <div class="input-group-btn"><button class="btn btn-primary">in Kg</button></div>
                                </div>                                             
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group"> 
                                    <input class="form-control" type="text" name="addt_charges" id="addt_charges" style="text-align: right;">
                                    <div class="input-group-btn"><button class="btn btn-success"><i class="fa fa-rupee"></i></button></div>
                                </div>
                            </div> 
                         </div>
