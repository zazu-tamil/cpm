        ...
        <div class="col-xs-12" id="mtc">
            <table class="table table-condensed table-bordered " id="content-table"> 
                <tr>
                    ...
                    <td colspan="12" align="center" style="border: 1px solid black;">
                ...
                <tr>
                    <td colspan="17" align="center" style="border: 1px solid black;"><strong style="font-size: 18px;">Material Test Certificate</strong></td>
                </tr> 
                <tr>
                    <td style="border: 1px solid black;" width="50%" colspan="8"><strong>MTC No : MJP/<?php echo $record_list[0]['dc_no']?></strong></td>
                ...
                <tr>
                     <td style="border: 1px solid black;" colspan="8"><strong>Customer : <?php echo $record_list[0]['customer']?></strong></td>
                    ...
                    <?php foreach($mtc_list as $item => $rec) {?>
                        <tr style="font-weight: bolder;">
                            ...
                            <td colspan="2" style="border: 1px solid black;">Grade : <strong><?php echo $rec[0]['grade_name']; ?></strong></td>
                        ...
                        <tr>
                            ...
                            <td align="center" style="border: 1px solid black;"><?php echo $info['f_tensile']; ?></td>
                            <td align="center" style="border: 1px solid black;"><?php echo $info['f_yield_strength']; ?></td>  
                            <td align="center" style="border: 1px solid black;"><?php echo $info['f_elongation']; ?></td> 
                        ...
                        <tr> 
                             ...
                             <td  style=" border: 1px solid black;" colspan="13"></td>
                        </td>     
                        <?php } ?>
                ...
                <tr> 
                    ...
                    <td colspan="5" style=" border: 1px solid black;vertical-align: middle;font-weight: bold;" align="center" >
                ...
                <tr>
                    <td valign="bottom" style="height: 70px;border: 1px solid black;"  align="center" colspan="8"><strong>Prepared By</strong></td>
                    <td valign="bottom" align="center" style="border: 1px solid black;" colspan="9"><strong>Approved By</strong></td>
                </tr>
            </table>
        </div>
    </div>
