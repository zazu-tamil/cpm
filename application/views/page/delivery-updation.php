                ...
                <div class="form-group col-md-6">
                    <div class="row">
                        ...
                        <div class="form-group col-xs-6 text-center">
                            ...
                            <input class="status_opt flat-red" id="status1"  type="radio" name="status" value="Delivered" checked="true">  
                        </div>
                        <div class="form-group col-xs-6 text-center"> 
                            <label for="status2">Un-Delivered</label> 
                            <input class="status_opt flat-red" id="status2" type="radio" name="status" value="Un-Delivered"> 
                        </div>
                    </div>
                    <span class="ndr_drp">
                    <i class="text-maroon"> Note : If consignment is Un-Delivered specify appropriate reason</i><br />
