        ...
        <div class="box-body">
             ...
             <div class="row">   
                 ...
                 <div class="form-group col-md-3">
                    <label>Branch</label>
                      <div class="input-group">
                        <?php echo form_dropdown('branch_city_code',array('' => 'Select') + $state_opt ,set_value('branch_city_code','') ,' id="branch_city_code" class="form-control"');?> 
                      </div>                                   
                 </div>  
            ...
            <div class="box-footer with-border">
                 ...
                 <div class="form-group col-md-4">
                     <label>Delivery By :</label>  
                         <?php echo form_dropdown('delivery_by',array('' => 'Select') +$delivery_by_opt  ,set_value('delivery_by') ,' id="delivery_by" class="form-control"');?>
                 </div> 
