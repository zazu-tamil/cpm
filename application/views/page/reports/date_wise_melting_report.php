...
<section class="content"> 
        ...
        <div class="box-body">
         ...
         <div class="box box-success"> 
            <div class="box-header with-border">
              <h3 class="box-title text-white">Cumulative Melting Summary </h3> 
            </div>
            <div class="box-body table-responsive">  
                ...
                <table class="table table-bordered table-striped table-responsive">
                    ...
                    <?php 
                     $tot_liq_metal = 0;
                    foreach($record_list as $itm => $info) {?>
                    <tr>
                        <td><?php echo $itm; ?></td>
                        <?php  $tot_qty= 0;
                        for ($j=1 ;$j<=(date('t',strtotime($srch_month)));$j++){
                    ...
                    <?php $tot_liq_metal += ($info['weight'] * $tot_qty);
                    } ?> 
                        <tr>
                            <td colspan="<?php echo ((date('t',strtotime($srch_month))) + 3)?>">Total</td>
                            <td><?php echo number_format($tot_liq_metal,3); ?></td>
                        </tr>
