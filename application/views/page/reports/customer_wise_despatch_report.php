<?php  include_once(VIEWPATH . '/inc/header.php'); ?>
 <section class="content-header">
  <h1>Customer Wise Despatch Report</h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-book"></i> Report</a></li> 
    <li><a href="#"><i class="fa fa-book"></i> Despatch Report</a></li> 
    <li class="active">Customer Wise Despatch Report</li>
  </ol>
</section>
<!-- Main content -->
             ...
             <div class="row">   
                 ...
                 <div class="form-group col-md-3">
                    <label>Sub Contractor[Machining]</label>
                      <div class="input-group">
                        <?php echo form_dropdown('srch_sub_contractor_id',array('' => 'All Sub-Contractor[Machining]') + $sub_contractor_opt  ,set_value('srch_sub_contractor_id') ,' id="srch_customer_id" class="form-control" ');?> 
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $info['dc_no']?></td>
                                <td><?php echo $info['invoice_no']?></td>
                                <td><?php echo $info['sub_contractor']?></td>
