<?php  include_once(VIEWPATH . '/inc/header.php'); ?>
 <section class="content-header">
  <h1>Customer Wise Master Item List</h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-book"></i> Report</a></li> 
    <li class="active">Customer Wise Master Item List</li>
  </ol>
</section>
<!-- Main content -->
<section class="content"> 
        ...
        <div class="box-body">
         ...
         <div class="box box-success"> 
            <div class="box-header with-border">
              <h3 class="box-title text-white">Customer Wise Master Item List</h3> 
            ...
            <div class="box-body table-responsive">  
                ...
                <table class="table table-bordered table-striped ">
                    ...
                    <tr class="bg-blue-gradient">
                        ...
                        <th class="text-left">Match Plate No</th> 
                        <th class="text-right">No of Cavity</th>
                        <th class="text-right">Pouring Weight</th> 
                        <th class="text-right">Pieces Weight</th> 
                        <th class="text-right">RC Weight</th> 
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th colspan="7"><?php echo $customer;?></th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><?php echo number_format($info['pouring_weight'],3);?></td> 
                            <td class="text-right"><?php echo number_format($info['piece_weight_per_kg'],3);?></td> 
                            <td class="text-right"><?php echo number_format($info['casting_weight'],3);?></td> 
                            <td class="text-right"><?php echo number_format($info['yeild'],2);?></td> 
