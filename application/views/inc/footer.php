...
<footer class="main-footer no-print">
    ...
    <strong>Copyright &copy; <?php echo date('Y');?> MJP Entriprises.</strong> All rights
    reserved.
</footer>
...
<!-- Control Sidebar -->
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
      <li class="hide"><a href="#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
